        ...
        profileExport.findOne({
            ...
            if (!Data) {
                      ...
                      //  console.log(deviceId)
                        ...
                        request(token_request, async function (error, response2) {
                            ...
                            profile.save().catch(err => {
                                console.log(err)
                                return interaction.followUp("There was an err: profile")
                            })
                            let twitter = await twitterExport.create({
                                "appKey": null,
                                "appSecret": null,
                                "accessToken": null,
                                "accessSecret": null,
                            ...
                            twitter.save().catch(err => {
                                console.log(err)
                                return interaction.followUp("There was an err: twitter")
                            })
                            const embed = new MessageEmbed()
                ...
                const embed = new MessageEmbed()
                    ...
                    .setDescription("If you would like to change your account then please do /relogin")
                    .setColor("RANDOM")
                    .setFooter({ text: interaction.member.user.username })
                return interaction.followUp({ embeds: [embed] })
            }
